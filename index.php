<?php 
	...
	<div class='col-md-12' align='center'>
		<a class='btn btn-sm btn-primary' href='https://tuweb.cu' role='button'>Tu Web</a>
	</div>";
	...
	<body>
		<div class="container">
			<div align="center">
				<!-- Header start -->
				<div class="row">
					<div class="col" align="center"><i class="fas fa-image fa-10x text-primary"></i></div>
				</div>	
				
				<div class="fs-3 text-secondary">Plantilla, autent&iacute;quese</div>
				...
				<form name="frmInicio" method="post" action="" class="form-signin">
					...
					<button class="w-100 btn btn-lg btn-primary" type="submit" name="login">Acceder</button>
				</form>
